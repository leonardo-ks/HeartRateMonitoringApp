...
import com.example.heartratemonitoringapp.dashboard.profile.contact.showcontactdata.ShowContactDataActivity
...
class ContactActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mAdapter.onItemClick = {
            val intent = Intent(this, ShowContactDataActivity::class.java)
