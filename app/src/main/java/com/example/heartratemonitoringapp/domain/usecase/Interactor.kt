...
class Interactor(private val repository: IRepository): IUseCase {
    ...
    override fun addData(bearer: String, avgHeartRate: Int, stepChanges: Int, step: Int, label: String?): Flow<Resource<Boolean>> = repository.addData(bearer, avgHeartRate, stepChanges,step, label.toString())
