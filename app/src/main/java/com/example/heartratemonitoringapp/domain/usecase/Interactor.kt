...
class Interactor(private val repository: IRepository): IUseCase {
    ...
    override fun addData(bearer: String, avgHeartRate: Int, avgStep: Int, label: String?): Flow<Resource<MonitoringDataDomain>> = repository.addData(bearer, avgHeartRate, avgStep, label.toString())
