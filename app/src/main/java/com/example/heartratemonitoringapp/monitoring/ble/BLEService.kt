...
import com.example.heartratemonitoringapp.monitoring.ble.BLE.bluetoothAdapter
import com.example.heartratemonitoringapp.monitoring.ble.BLE.bluetoothGatt
...
class BLEService: Service() {
    ...
    private val bluetoothGattCallback = object : BluetoothGattCallback() {
        ...
        override fun onServicesDiscovered(gatt: BluetoothGatt?, status: Int) {
            val heartRateCharacteristic = gatt?.getService(UUIDs.HEART_RATE_SERVICE)?.getCharacteristic(
