...
class Interactor(private val repository: IRepository): IUseCase {
    ...
    override fun getUserMonitoringDataByDateById(bearer: String, id: Int, start: String, end: String): Flow<Resource<List<MonitoringDataDomain>>> = repository.getUserMonitoringDataByDateById(bearer, id, start, end)
    override fun getAverageData(bearer: String): Flow<Resource<AverageDomain>> = repository.getAverageData(bearer)
    override fun getAverageDataById(bearer: String, id: Int): Flow<Resource<AverageDomain>> = repository.getAverageDataById(bearer, id)
    ...
    override fun sendNotification(bearer: String, status: Int, vibrate: Boolean): Flow<Resource<String>> = repository.sendNotification(bearer, status, vibrate)
